...
class Usuario {
    ...
    public static function listar() {
        ...
        foreach ($usuarios as $usuario) {
            ...
            $objetos[] = new Usuario($usuario['id'], Perfil::buscar($usuario['id_perfil']), $usuario['login']);
        }
    ...
    public static function logar($login, $senha) {
        ...
        // retornando o Usuario //
        return new Usuario($usuario['id'], Perfil::buscar($usuario['id_perfil']), $usuario['login']);
    }
